...
*/
#ifndef __shttp_logstream_h
#define __shttp_logstream_h
...
/*!
* \brief Implementation of a iostream interface for files.
*
* LogStream implements the handling for TCP/IP sockets as a iostream. It inherits from streambuf
...
*
* Example on how to use LogStream:
*
*     int sock;
*     ...
*     sock = accept(…);
...
private:
    ...
    * It reads data from the file_id and puts it in_buf. See \class std::streambuf for more
    * information.
    *
...
protected:
public:
    inline LogStream() {in_buf = out_buf = NULL; in_bufsize = out_bufsize = 0; fid = -1; putback_size = 0; }
    ...
    */
    LogStream(const std::string &filename, int in_bufsize_p = 8192, int out_bufsize = 8192, int putback_size_p = 32);
