...
curl -sSf -o "$FILENAME_DOWN_8" -O "http://localhost:1024/knora/Leaves8.tif/full/full/0/default.$IMAGE_EXTENTION"

test_check $1 $FILENAME_DOWN_8

curl -sSf -o "$FILENAME_DOWN_16" -O "http://localhost:1024/knora/Leaves16.tif/full/full/0/default.$IMAGE_EXTENTION"
